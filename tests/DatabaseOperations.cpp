...
using Fixtures = boost::mpl::list<Fixture<DatabaseType::MYSQL>, Fixture<DatabaseType::POSTGRESQL, false>, Fixture<DatabaseType::POSTGRESQL, true>, Fixture<DatabaseType::SQLITE> >;
